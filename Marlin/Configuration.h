...
#define HOTEND_OFFSET_X {0.0, 20.00, 0.0, 20.00} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {0.0, 0.0, 20.00, 20.00}  // (in mm) for each extruder, offset of the hotend on the Y axis
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 519.65
  #define  DEFAULT_bedKi 97.89
  #define  DEFAULT_bedKd 689.64
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 5*16, 5*16, 25*32, 476.5/16*16 } //[steps/mm at 200 steps/rev] * microsteps
