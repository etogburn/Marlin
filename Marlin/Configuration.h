...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 50.35
  #define DEFAULT_Ki 3.10
  #define DEFAULT_Kd 204.60
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 705 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -5.15   // Z offset: -below +above  [the nozzle]
